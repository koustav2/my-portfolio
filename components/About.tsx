...
export default function About({ }: Props) {
    return (
        <motion.div
            ...
            <motion.img
                className='-mb-20 md:mb-0 flex-shrink-0 w-56 h-56 rounded-full object-cover md:rounded-lg md:w-64 md:h-95 xl:w-[400px] xl:h-[400px] mt-[15rem] md:mt-0 lg:mt-0'
                initial={{
                    x: -200,
                    opacity: 0
                }}
